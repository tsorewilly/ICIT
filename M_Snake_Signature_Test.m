% figure; workspace=circle3([30, 9, 15], 5)'; hold on;
...
workspace=C_3;
plot3(workspace(:,1), workspace(:,2), workspace(:,3), '-b', 'LineWidth', 2); hold on;
...
for Id=1:Lent            %[29626 30330]
    ...
    vars2keep = {'C_3','C_d','C_f','C_o','start_timer','PL1','RL1','d1','LinkNo','Twist','L','ALL','SnakeRobot','Links','workspace','Threshold','Lent','Good','Bad','Comples','Perf','MoreBa','JustBa','GoodPoint', 'BadPoint','Perfect','Almost','BitFar','ComplexPoint'};    
